...
from ...core import set_svg_image, set_svg_icon
...
class PyTitleBar(QWidget):
    ...
    def setup_ui(self):
        ...
        self.close_button = PyTitleButton(
            ...
            close_connection=self._parent.close
        )
        self.close_button.released.connect(self.close_connection)
        # ADD TO LAYOUT
